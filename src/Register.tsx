      ...
      <div className='bg-slate-800 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative'>
        <div className='flex flex-col mb-4'>
          <div className='relative mb-4 flex justify-center'>
            <div className="flex">
            <button className={`w-32 py-2 px-3 text-${activePage === 'signup' ? 'black' : 'white'} bg-${activePage === 'signup' ? 'white' : 'customGray'} border border-white rounded-md focus:outline-none focus:border-blue-600`} onClick={handleSignup}>Signup</button>
            <button className={`w-32 py-2 px-3 text-${activePage === 'login' ? 'black' : 'white'} bg-${activePage === 'login' ? 'white' : 'customGray'} border border-white rounded-md focus:outline-none focus:border-blue-600`} onClick={handleLogin}>Login</button>
            </div>
          </div>
